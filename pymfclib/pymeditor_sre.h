...
#include "pymeditor_sre_constants.h"
...
typedef struct SRE_REPEAT_T {
    ...
    PymRePtr last_ptr; /* helper to check for infinite loops */
...
typedef struct {
    /* string pointers */
    PymRePtr ptr; /* current position (also end of current slice) */
    PymRePtr beginning; /* start of original string */
    PymRePtr start; /* start of current slice */
    PymRePtr end; /* end of original string */
