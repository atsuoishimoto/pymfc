...
cdef extern from "shlobj.h":
    ...
    # CSIDL
    cdef ULONG CSIDL_DESKTOP, CSIDL_INTERNET, CSIDL_PROGRAMS, CSIDL_CONTROLS
    cdef ULONG CSIDL_PRINTERS, CSIDL_PERSONAL, CSIDL_FAVORITES, CSIDL_STARTUP
    cdef ULONG CSIDL_RECENT, CSIDL_SENDTO, CSIDL_BITBUCKET, CSIDL_STARTMENU
    cdef ULONG CSIDL_MYDOCUMENTS, CSIDL_MYMUSIC, CSIDL_MYVIDEO, CSIDL_DESKTOPDIRECTORY
    cdef ULONG CSIDL_DRIVES, CSIDL_NETWORK, CSIDL_NETHOOD, CSIDL_FONTS
    cdef ULONG CSIDL_TEMPLATES, CSIDL_COMMON_STARTMENU, CSIDL_COMMON_PROGRAMS
    cdef ULONG CSIDL_COMMON_STARTUP, CSIDL_COMMON_DESKTOPDIRECTORY, CSIDL_APPDATA
    cdef ULONG CSIDL_PRINTHOOD, CSIDL_LOCAL_APPDATA, CSIDL_ALTSTARTUP
    cdef ULONG CSIDL_COMMON_ALTSTARTUP, CSIDL_COMMON_FAVORITES, CSIDL_INTERNET_CACHE
    cdef ULONG CSIDL_COOKIES, CSIDL_HISTORY, CSIDL_COMMON_APPDATA, CSIDL_WINDOWS
    cdef ULONG CSIDL_SYSTEM, CSIDL_PROGRAM_FILES, CSIDL_MYPICTURES, CSIDL_PROFILE
    cdef ULONG CSIDL_SYSTEMX86, CSIDL_PROGRAM_FILESX86, CSIDL_PROGRAM_FILES_COMMON
    cdef ULONG CSIDL_PROGRAM_FILES_COMMONX86, CSIDL_COMMON_TEMPLATES
    cdef ULONG CSIDL_COMMON_DOCUMENTS, CSIDL_COMMON_ADMINTOOLS, CSIDL_ADMINTOOLS
    cdef ULONG CSIDL_CONNECTIONS, CSIDL_COMMON_MUSIC, CSIDL_COMMON_PICTURES
    cdef ULONG CSIDL_COMMON_VIDEO, CSIDL_RESOURCES, CSIDL_RESOURCES_LOCALIZED
    cdef ULONG CSIDL_COMMON_OEM_LINKS, CSIDL_CDBURN_AREA, CSIDL_COMPUTERSNEARME
    cdef ULONG CSIDL_FLAG_CREATE, CSIDL_FLAG_DONT_VERIFY, CSIDL_FLAG_DONT_UNEXPAND
    cdef ULONG CSIDL_FLAG_NO_ALIAS, CSIDL_FLAG_PER_USER_INIT, CSIDL_FLAG_MASK
...
cdef void __init_csidl(obj):
    ...
    obj.mydocuments = CSIDL_MYDOCUMENTS
    obj.mymusic = CSIDL_MYMUSIC
    obj.myvideo = CSIDL_MYVIDEO
    ...
    obj.local_appdata = CSIDL_LOCAL_APPDATA
    ...
    obj.common_appdata = CSIDL_COMMON_APPDATA
    obj.windows = CSIDL_WINDOWS
    obj.system = CSIDL_SYSTEM
    obj.program_files = CSIDL_PROGRAM_FILES
    obj.mypictures = CSIDL_MYPICTURES
    obj.profile = CSIDL_PROFILE
    obj.systemx86 = CSIDL_SYSTEMX86
    obj.program_filesx86 = CSIDL_PROGRAM_FILESX86
    obj.program_files_common = CSIDL_PROGRAM_FILES_COMMON
    obj.program_files_commonx86 = CSIDL_PROGRAM_FILES_COMMONX86
    obj.common_templates = CSIDL_COMMON_TEMPLATES
    obj.common_documents = CSIDL_COMMON_DOCUMENTS
    obj.common_admintools = CSIDL_COMMON_ADMINTOOLS
    obj.admintools = CSIDL_ADMINTOOLS
    obj.connections = CSIDL_CONNECTIONS
    obj.common_music = CSIDL_COMMON_MUSIC
    obj.common_pictures = CSIDL_COMMON_PICTURES
    obj.common_video = CSIDL_COMMON_VIDEO
    obj.resources = CSIDL_RESOURCES
    obj.resources_localized = CSIDL_RESOURCES_LOCALIZED
    obj.common_oem_links = CSIDL_COMMON_OEM_LINKS
    obj.cdburn_area = CSIDL_CDBURN_AREA
    obj.computersnearme = CSIDL_COMPUTERSNEARME
    obj.flag_create = CSIDL_FLAG_CREATE
    obj.flag_dont_verify = CSIDL_FLAG_DONT_VERIFY
    obj.flag_dont_unexpand = CSIDL_FLAG_DONT_UNEXPAND
#    obj.flag_no_alias = CSIDL_FLAG_NO_ALIAS
#    obj.flag_per_user_init = CSIDL_FLAG_PER_USER_INIT
    obj.flag_mask = CSIDL_FLAG_MASK
#    obj.desktop = CSIDL_DESKTOP
#    obj.internet = CSIDL_INTERNET
#    obj.programs = CSIDL_PROGRAMS
#    obj.controls = CSIDL_CONTROLS
